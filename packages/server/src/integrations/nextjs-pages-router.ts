...
export interface NextjsPagesRouterIntegrationOptions {
  routePrefix?: string;
  mountPath?: string;
}
...
function remapRequestUrl(
  url: string,
  options: NextjsPagesRouterIntegrationOptions,
): string {
...
export function nextjsPagesRouterIntegration<TService = unknown>(
