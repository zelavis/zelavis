...
function toSqlParameter(parameter: SqlParameter): unknown {
  return parameter instanceof Uint8Array ? Buffer.from(parameter) : parameter;
}
...
function createSqlApi(database: BetterSqlite3Database): SqlDatabase {
  return {
...
function createSchema(database: BetterSqlite3Database): void {
  database.exec(`
