...
export const Route = createFileRoute("/content/$contentType/settings")({
  component: ContentTypeSettingsRoute,
});

function ContentTypeSettingsRoute() {
  const { contentType } = useParams({ from: "/content/$contentType/settings" });
