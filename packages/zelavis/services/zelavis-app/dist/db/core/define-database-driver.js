export function defineDatabaseDriver(driver) {
    ...
    if (!driver.events || typeof driver.events.append !== "function") {
        throw new TypeError("A database driver must include an event append implementation.");
    }
    if (!driver.projections ||
        typeof driver.projections.findDocumentById !== "function") {
        throw new TypeError("A database driver must include projection read implementations.");
    }
    if (driver.schemas &&
        (typeof driver.schemas.list !== "function" ||
            typeof driver.schemas.save !== "function" ||
            typeof driver.schemas.activate !== "function")) {
        throw new TypeError("A database driver schema store must include list, save, and activate implementations.");
    }
