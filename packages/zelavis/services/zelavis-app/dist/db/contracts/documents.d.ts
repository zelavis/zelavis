...
export declare const DATABASE_COLLECTION_NAME_PATTERN: RegExp;
export declare const DATABASE_RESERVED_COLLECTION_NAMES: Set<string>;
export declare function validateDatabaseCollectionName(name: string): void;
