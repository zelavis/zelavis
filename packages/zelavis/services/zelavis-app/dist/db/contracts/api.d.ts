import type { CreateCollectionInput, DatabaseCollection, DatabaseDocument, DeleteDocumentInput, FindDocumentByIdInput, FindDocumentsInput, InsertDocumentInput, ListCollectionsInput, UpdateDocumentInput } from "./documents.js";
...
export interface DatabaseProjectionDefinition {
    ...
    apply?: (event: DatabaseEvent, context: DatabaseProjectionApplyContext) => Promise<void> | void;
}
...
export type DatabaseTimeSeriesAggregateOperation = "avg" | "sum" | "min" | "max" | "count";
...
export type DatabaseTimeSeriesMapper = (event: DatabaseEvent, context: DatabaseTimeSeriesMapperContext) => DatabaseTimeSeriesPoint | readonly DatabaseTimeSeriesPoint[] | null | undefined;
...
export interface DatabaseTimeSeriesHandle {
    range(input?: DatabaseTimeSeriesRangeInput): Promise<DatabaseTimeSeriesPoint[]>;
