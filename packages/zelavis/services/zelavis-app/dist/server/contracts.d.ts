...
export type ZelavisMenuFixedActionScope = "local" | "inherit" | "replace" | "clear";
export type ZelavisPrincipalType = "anonymous" | "user" | "service" | "system";
...
export interface ZelavisAccessAuthorizeContext<TService = unknown> extends ZelavisAccessResolveContext<TService> {
    principal?: ZelavisPrincipal;
    requirement: ZelavisAccessRequirement;
}
export type ZelavisPrincipalResolver<TService = unknown> = (context: ZelavisAccessResolveContext<TService>) => ZelavisPrincipal | undefined | Promise<ZelavisPrincipal | undefined>;
export type ZelavisAuthorizer<TService = unknown> = (context: ZelavisAccessAuthorizeContext<TService>) => boolean | ZelavisAccessDecision | Promise<boolean | ZelavisAccessDecision>;
...
export interface ZelavisServerRoute<TService = unknown> {
    ...
    handler: (context: ZelavisRouteContext<TService>) => Promise<ZelavisRouteResponse> | ZelavisRouteResponse;
}
...
export type ZelavisRuntimeServiceInput<TService = unknown> = ZelavisRuntimeService<TService> | Promise<ZelavisRuntimeService<TService>>;
export type ZelavisAnyRuntimeServiceInput = ZelavisRuntimeService<any> | Promise<ZelavisRuntimeService<any>>;
...
export type ZelavisServerErrorHandler<TService = unknown> = (context: ZelavisServerErrorContext<TService>) => ZelavisRouteResponse;
...
export type ZelavisServerDispatchHandler<TService = unknown> = (request: Request, context?: ZelavisServerExecutionContext) => Promise<ZelavisServerDispatchResult<TService>>;
export type ZelavisServerFetchHandler<TService = unknown> = (request: Request, context?: ZelavisServerExecutionContext) => Promise<Response>;
...
export type ZelavisServerPlainHandler<TService = unknown> = (request: ZelavisPlainRequest) => Promise<ZelavisPlainResponse<TService>>;
export interface ZelavisServerOptions<TService = unknown> extends ZelavisServerMountOptions<TService> {
    services: readonly ZelavisAnyRuntimeServiceInput[];
}
