...
test("the database service mounts the same routes on the db runtime API", async (t) => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      "/api/database/documents/:collection/related",
      "/api/database/documents/:collection/analyzer",
      "/api/database/documents/:collection/geometry",
      "/api/database/documents/:collection/embedding",
      ...
      "/api/database/timeseries/:series/windows",
      "/api/database/timeseries/:series/moving",
      "/api/database/timeseries/:series/histogram",
      "/api/database/timeseries/:series/interpolate",
      "/api/database/timeseries/:series/ingest",
