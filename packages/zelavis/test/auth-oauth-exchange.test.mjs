...
import { createAuthorizationCodeFlow } from "../dist/app/identity/index.js";
import { githubProvider } from "../dist/app/identity/index.js";
...
test("a definition declaring an issuer with no key set is refused at definition time", async () => {
  const { defineOAuthProviders } = await import("../dist/app/identity/index.js");
