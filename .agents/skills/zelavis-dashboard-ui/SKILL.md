...
description: Use when working on the Zelavis dashboard UI in packages/zelavis/services/ui, including React Router v7 routes, the slide-based sidebar, mounted /zelavis dev behavior, and embedded-runtime dashboard mounting.
---
