...
async function main() {
  ...
  runSetup(
    "pnpm --filter @zelavis/server build && pnpm --filter @zelavis/app build && pnpm --filter @zelavis/app-db-node-sqlite build && pnpm --filter @zelavis/ui build:plugin && pnpm --filter zelavis build:runtime",
  );
