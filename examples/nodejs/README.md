...
- `http://localhost:3000/zelavis/projects/default`
- `http://localhost:3000/zelavis/projects/default/media`
...
- it uses `createNodeServer(zv)` from `zelavis/node` to spin up a standalone HTTP server
...
1. upload a file from `/zelavis/projects/default/storage`
...
Open `http://localhost:3000/zelavis/projects/default/marketplace`, select
